<html>
    <head>
        ...
        <meta name="author" content="MUHAMMAD ADRIAN REYESTA"></meta>
    </head>
    <body>
        ...
        <table border="1" width="1200px" height="700px" align="center">
            ...
            <tr height="50px" style="background-color:dodgerblue;">
                <td align="center" style="word-spacing: 4em;">
                    ...
                    <a href="https://www.linkedin.com/in/adrian-reyesta-95773a218" style="text-decoration: none; color: white;"><em>Linkedin</em></a>
                    <a href="https://www.instagram.com/adrianreyesta/" style="text-decoration: none; color: white;"><i>Instagram</i></a>
                </td>    
            </tr>
            ...
            <tr height="450px" style="background-color: dodgerblue;;">
                <td valign="top">
                    ...
                    <tr>
                            <!-- internal link-->
                            <td>
                                <embed autostart="false" height="100%" src="video/smk4.mp4" width="250"></embed>
                            </td>
                            <td>
                                <embed autostart="false" height="100%" src="video/smk4.mp4" width="250"></embed>
                            </td>
                        ...
                        <tr >
                            <!-- external link-->
                            <td>
                                <iframe width="250px" height="200" style="margin-top: 50px;" src="https://www.youtube.com/embed/7-QNafrXigs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </td>
                            <td>
                                <iframe width="250px" height="200" style="margin-top: 50px;" src="https://www.youtube.com/embed/7-QNafrXigs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </td>
            ...
            <tr height="50px" style="background-color: dodgerblue;">
                <td>
                    <p align="center" style="color: white;">MUHAMMAD ADRIAN REYESTA XI-RPL2</p>
                </td>    
            </tr>
        </table>
    </body>
